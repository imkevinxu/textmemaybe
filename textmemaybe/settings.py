# Django settings for textmemaybe project.
...
DATABASES = {
    'default': {
        ...
        'NAME':  'textmemaybe',                      # Or path to database file if using sqlite3.
        'USER': 'textmemaybe_user',                      # Not used with sqlite3.
        'PASSWORD': 'OS9o9c3OkV0Fq4vGqacNQxhTAanbip',                  # Not used with sqlite3.
...
SECRET_KEY = 'l!7.c*5s"hE,n5CZ0="@9BXia|W0:k>VhG<by^6,1!GwGusadZ'
...
ROOT_URLCONF = 'textmemaybe.urls'

WSGI_APPLICATION = 'textmemaybe.wsgi.application'
